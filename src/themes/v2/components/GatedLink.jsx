  ...
  return (
    <>
      <a
        ...
        className={className}
        onClick={startGate}
        onKeyDown={activateOnSpace(startGate)}
        {...rest}
      >
        {children}
      </a>
      {open && createPortal(
        ...
        >
          <form
            className="bg-[#161d38] border-[3px] border-gold rounded-[10px] px-[1.8rem] py-[1.6rem] max-w-[22em] w-full text-center shadow-[0_8px_0_rgba(0,0,0,0.35)]"
          ...
          >
            ...
            <input
              ...
              className="w-full text-center font-mono text-[0.95rem] bg-black/30 border-2 border-white/25 rounded-[8px] px-4 py-2 text-white mb-3 focus:outline-none focus:border-gold"
            />
            {error && <p className="font-mono text-[0.75rem] text-red mb-3">Not quite — try again.</p>}
